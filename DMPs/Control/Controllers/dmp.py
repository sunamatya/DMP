...
class Shell(trajectory.Shell):
    ...
    def gen_path(self, trajectory):
        ...
        # shows where the trajectory is zero
        ...
        for ii in range(self.num_seqs):
            ...
            seq = trajectory[:, breaks[ii]+1:breaks[ii+1]] #all row values besides from 1 tp 100
            # hence seq is data bhako trajectory
            ...
            dmps.imitate_path(y_des=seq, plot=True)
